...
//
//	"github.com/ydessouky/enms-OTel-collector/exporter/kafkaexporter/internal/awsmsk"
//)
//
...
//func ConfigureAuthentication(config Authentication, kafkaConfig *kafka.ConfigMap) error {
//	if config.PlainText != nil {
//		configurePlaintext(*config.PlainText, kafkaConfig)
//	}
//	if config.TLS != nil {
//		if err := configureTLS(*config.TLS, kafkaConfig); err != nil {
//			return err
//		}
//	}
//	if config.SASL != nil {
//		if err := configureSASL(*config.SASL, kafkaConfig); err != nil {
//			return err
//		}
//	}
//
...
//}
//
//func configurePlaintext(config PlainTextConfig, kafkaConfig *kafka.ConfigMap) {
